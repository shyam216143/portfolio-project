...
export const metadata = {
  title: 'Shyam | Software Engineer',
  description: 'Shyam Kumar is a Full Stack Developer with 2+ years of experience.',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className='!scroll-smooth'>
      <body className={`${inter.className} bg-gray-50 text-gray-950 relative pt-28 sm:pt:36 dark:bg-gray-900 dark:text-gray-50 data:text-opacity-90`}>
