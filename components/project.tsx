  ...
  return (
    ...
    >
      <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
        ...
        <p className="mt-2 leading-relaxed text-grey-700 dark:text-white/70">{description}</p>
      ...
      transition group-hover:-translate-x-3 group-hover:translate-y-3 group-hover:-rotate-2 group-hover:scale-[1.04]
